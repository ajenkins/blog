...
Our founding leaders thought they had given us a tool to get us out of any mess: the consitutional amendment.
Unfortunately, passing a consitutional amendment requires a two-thirds majority in _both_ houses of Congress
...
replaces plurality voting*. If you've never heard of plurality voting, it's the basic voting system that you 
probably just think of as "voting." First I'll explain how plurality voting works so you can see how RCV is different. 
In plurality voting voters pick their one, favorite** candidate from a list of possible candidates. The winner is whoever
...
when similar candidates run against each other***. When political pundits talk about a "spoiler candidate", they
...
Another cool thing about RCV is that primaries themselves are actually unnecessary****. If you've ever wondered why we
...
1. **The country is more divided than ever** - I actually don't believe this is true. I think that most of the
   ...
   between Democrats and Republicans which makes us feel divided. I know many Democrats who can't imagine how
...
*: Technically RCV and plurality voting can be used for voting on anything, not just candidates.
...
**: People often _don't_ vote for their favorite candidate, but instead vote for different candidate.
    This is known as tactical voting, which is explained later.

***: This is known also known as
...
****: Of course, you would still need some way of qualifying candidates for the election so voters
